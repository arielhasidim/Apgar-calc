...
const ApgarCalculator = () => {
  ...
  const saveScore = () => {
    ...
    setSavedScores((prev: any) => [...prev, newScore]);
    setShowAlert(false);
  };

  const copyToClipboard = () => {
    const text = savedScores.map((score: { timeMinutes: any; total: any; }) => 
          ...
          <div className="mt-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {savedScores.map((score: { timeMinutes: any; total: any; }, index: any) => (
